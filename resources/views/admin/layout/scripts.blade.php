        ...
        <script src="{{ asset('assets/admin/js/stopsale.js') }}"></script>
        <script src="{{ asset('assets/admin/js/flight.js') }}"></script>
        <script src="{{ asset('assets/admin/js/transfer.js') }}"></script>
       @yield('scripts')
