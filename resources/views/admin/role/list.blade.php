        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                ...
                <div class="actions">
                    ...
                    <a href="{{route('roles.create')}}" class="btn btn-primary margin-top-10">Add New Role</a>
                </div>
                ...
                @foreach($roles as $role)
                    <tr>
                      <td>
                        ...
                        <td>
                          <a href="{{route('roles.edit', $role->id)}}" class="btn btn-outline btn-circle btn-sm green">
